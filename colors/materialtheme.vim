...
hi Normal guibg=#263238 guifg=#eeeeec gui=NONE 
...
hi FoldColumn guibg=#263238 guifg=#607d8b
...
hi Comment gui=italic guifg=#546e7a ctermfg=Grey gui=NONE
hi Todo guifg=#80cbc4 guibg=#37474f
hi Constant guifg=#ffd54f gui=NONE
hi Type guifg=#C29BC9 gui=NONE
hi Function guifg=#e57373 gui=bold
hi Statement guifg=#ff8a65
hi Identifier guifg=#AD7FA8 gui=NONE
hi PreProc guifg=#e9ba6e gui=NONE
hi Special term=underline guifg=#64b5f6
hi Number guifg=#80cbc4 gui=NONE
hi String guifg=#80cbc4 gui=NONE
hi Boolean guifg=#80cbc4 gui=NONE

hi Search guifg=#81c784 guibg=#263238
